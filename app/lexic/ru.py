...
=======
Для записи тренировки укажите пройденные трассы через ",", каждый подход на новой строке. Если на трассе был срыв, пишите количество срывов ":число". f — флэш, rp — ред поинт. Комментарий можно оставить после дефиса.

Пример:
>>>>>>> e12c2a3770804c31bbb242c675e4eddc5cbaf75c
