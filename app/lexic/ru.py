...
/edit_journals — добавить / редактировать / удалить журнал
...
Мы создадим журнал — место, где вы можете хранить записи о своем тренировочном цикле. Используйте его также для группировки тренировок, например, для скального выезда.
...
MAIN_MENU: dict[str, str] = {
    ...
    "/edit_journals": "Редактировать журнал",
    "/cancel": "Отмена",
}
...
FSM_ADD_TRAIN: dict[str, str] = {
    ...
    "chosen_journal": "Текущий тренировочный журнал: {}"
}
...
EDIT_JOURNAL: dict[str, str] = {
    ...
    "del_select_to": "Выберите журнал_ы для удаления:",
    "del_select_empty": "Выберите журнал для удаления!",
    "del_confirm": "Подтвердить удаление журналов:\n\n{}",
    "del_cancel_success": "Удаление успешно ЗАВЕРШЕНО",
    "del_cancel_f": "Удаление ОТМЕНЕНО",
}
